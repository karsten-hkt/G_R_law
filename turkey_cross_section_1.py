...
#读取数据
data_locate = '../out_file/buffer_generate/aftershocks_in_buffer_0.csv'
data = pd.read_csv(data_locate)
#将data专为numpy方便计算
data_numpy = np.array(data)
#参数设置
para = {'day_line':0, 'lon_line':2, 'lat_line':3, 'dep_line':4, 'mag_line': 5, 'delta_M':0.1, 'roi':[34,41,35,40],
        'delta_time':10, 'spacing':2, 'buf':5, 'calculate_min_number':50,'ext':[-100,170,0,25], 'strike':66.6,
...
out_gmt_locate = '../out_file/cross_section/'
#other epi:
