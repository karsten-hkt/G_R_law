...
#读取数据c
fault_name = '../data/turkey_7_7_fault_text.dat'
#这个断层的数据有所区别
...
para = {'day_line':0, 'lon_line':2, 'lat_line':3, 'dep_line':4, 'mag_line': 5, 'delta_M':0.1,
        ...
        'drawing_number':1, 'buffer_length': 30000, 'depth':20,'projected_points_save':False}
#主震
...
for tmp_time in range(para['drawing_number']):
    ...
    outgmt_name = '3d_Turkey_2023_cross_section_Mw77_%s_' % para['delta_time']
    out_gmt_locate = '../out_file/3d_cross_section_Mw77/'
    #按顺序读取断层
